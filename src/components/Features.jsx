...
const Features = () => {
  ...
  return (
    <div className="h-125 bg-accent flex justify-center text-center pt-20">
      <div className="space-y-6">
        ...
        <div  className=" gap-5 pt-5 grid grid-cols-1 items-center md:grid-cols-4">
          {data.map((item) => {
            return (
              <div className="bg-primary w-60 h-50  flex flex-col items-center space-y-7 pt-8 rounded-xl " >
